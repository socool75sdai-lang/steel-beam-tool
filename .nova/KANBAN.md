...
| 6R5 | Brace PDF (3-page ASCII) — Item 2 | DONE | (main) | 06ee913 |
| 6I1 | Integration QA — all four items, browser + PDF evidence | DONE | (main) | — |

All cards DONE (2026-06-06). tsc 0 errors, build clean, all browser/PDF QA gates green.
Evidence: `.nova/evidence/rev6/`.
